    ...
    $.fn.circliful = function(options) {
        ...
        var settings = $.extend({
         ...
         return this.each(function() {
                ...
                if($(this).data('linewidth') != undefined) {
			  ...
			  if($(this).data('type') != undefined) {
					...
					if(type == 'half') {
						...
						var endAngle = Math.PI*0.885;
						var circ = Math.PI * 1.0;
						var quart = Math.PI / 0.9;
					}
                }
			  ...
			  function animate(current) {
				...
				context.beginPath();
				context.arc(x, y, radius, -(quart), ((circ) * current*1.21	) - quart, false);
				context.lineWidth = lineWidth;
				// line color
				var my_gradient=context.createLinearGradient(0,0,170,0);
				my_gradient.addColorStop(0,"#6BD0F4");
				// my_gradient.addColorStop(0.5,"red");
				my_gradient.addColorStop(1,"#27539D");
